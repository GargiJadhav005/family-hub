...
import { ArrowRight, Trophy, Palette, FlaskConical } from 'lucide-react';
    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <p className="text-sm md:text-base mb-3 tracking-wide text-gray-200">इयत्ता १ ली ते ४ थी</p>
            <p className="text-sm md:text-base mb-3 text-gray-300">न्या. रानडे विद्याप्रसारक मंडळ संचालित, निफाड</p>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold leading-tight mb-4">वैनतेय प्राथमिक विद्या मंदिर</h1>
            <p className="text-lg md:text-xl text-gray-200 mb-6">निफाड, ता. निफाड, जि. नाशिक.</p>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link to="/admissions">
                <Button size="lg" className="bg-primary text-white hover:bg-primary/90 px-8">प्रवेशासाठी अर्ज करा</Button>
              </Link>
              <Link to="/campus">
                <Button variant="outline" size="lg" className="border-white text-white hover:bg-white hover:text-black px-8">अधिक माहिती</Button>
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-16 md:py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="section-subtitle max-w-2xl mx-auto">मुलांच्या सर्वांगीण विकासासाठी आमची विविध प्रकारची शैक्षणिक आणि सहशालेय उपक्रम प्रणाली.</p>
          <div className="grid md:grid-cols-3 gap-6 mt-8">
            {activities.map((a, i) => (
              <motion.div key={a.title} className="portal-card text-left hover:shadow-lg transition-shadow" custom={i} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
      ...
      <section className="py-16 bg-secondary/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground text-sm">आमच्या शाळेतील सुविधा, कार्यक्रम आणि शैक्षणिक वातावरण.</p>
          </div>
      ...
      <section className="py-16 md:py-20">
        <div className="container mx-auto px-4 max-w-2xl">
          <div className="portal-card p-8 md:p-10">
            ...
            <p className="section-subtitle text-center">तुमच्या मुलाच्या भविष्यासाठी आज आमच्याशी संपर्क साधा.</p>
